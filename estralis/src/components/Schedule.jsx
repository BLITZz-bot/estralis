...
export const eventsDay1 = [
  ...
  },
  {
    ...
    coordinators: ["Ujwala Gowda - 8197388105", "Vishakha - 8431217851"],
    registerLink: "#",
    fee: "₹500",
  },
  {
  ...
  },
  {
    ...
    rules: ["Everyone should come at 8.30 for venue and the registration will be 8.30 to 9.30",
      "Eligibility is limited to students currently pursuing their undergraduate degree. Alumni and graduated students will not be accepted.",
      "Each team will be allotted a performance time of 3 to 10 minutes. Exceeding the time limit may result in penalties.",
  ...
  },
  {
    ...
    rules: ["Everyone should come at 8.30 for venue and the registration will be 8.30 to 9.30",
      ...
      "Time limit: 3 - 10 minutes (including entry & exit).",
