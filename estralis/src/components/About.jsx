    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row gap-12 lg:gap-24 items-center md:items-start">
        ...
        >
          ...
          <h2 className="astral-heading text-4xl sm:text-6xl lg:text-6xl mb-2 text-white uppercase tracking-tighter">
            ABOUT
          </h2>
          <h2 className="saarang-banner-text text-5xl sm:text-7xl lg:text-[4rem] text-teal-400 font-astral">
            ESTRALIS
          </h2>
        </motion.div>
        ...
        >
          <div className="astral-glass p-8 md:p-14 hover:border-teal-500/40 transition-all duration-500 relative group">
            <p className="text-white/70 text-base md:text-lg font-tech leading-relaxed mb-10">
            ...
            <p className="text-white/70 text-base md:text-lg font-tech leading-relaxed mb-12">
