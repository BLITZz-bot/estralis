...
import { eventsDay1, eventsDay2, specialEvents } from './Schedule';
...
export default function AdminDashboard({ isOpen, onClose }) {
    ...
    const [mailerVenue, setMailerVenue] = useState("GIS Auditorium, GOPALAN COLLEGE OF ENGINEERING AND MANAGEMENT");
                                ...
                                {!isControlsAuth ? (
                                    ...
                                    <div className="w-full h-full p-6 overflow-auto">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            {[...eventsDay1, ...eventsDay2, ...specialEvents].map(eventObj => {
                                            ...
                                            <div className="flex-1 flex flex-col gap-4">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input value={mailerVenue} onChange={(e) => setMailerVenue(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-emerald-500 transition" placeholder="e.g., GIS Auditorium, GOPALAN COLLEGE OF ENGINEERING AND MANAGEMENT" />
                                                    </div>
                                                    <div>
